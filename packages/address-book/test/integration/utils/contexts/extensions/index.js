...
// string literals when specifying regions.
...
//
// Returns an object containing supported and unsupported properties.
...
//
// Returned function is used by the integration tests config to wire up
// the context.exclude function. An exception is thrown if regions not supported
...
//
// Returned function is used by the integration tests config to wire up
// the context.include function. An exception is thrown if regions not supported
// by the application are detected.
...
// * With an array containing unsupported regions, an exception is thrown.
//
// You can override regions specified in via the REGIONS environment variable.
// This should be a comma delimited list of region country codes (e.g
// REGIONS="GB,PL" etc)
