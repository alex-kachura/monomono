module.exports = {
  externalApps: {
    ...
    tescoHomepage: 'https://www-ppe.tesco.pl',
    tescoSecure: 'https://secure-ppe.tesco.pl',
    login: '',
    logout: '',
  },
  supportLinks: [
    {
      href: 'https://www-ppe.tesco.pl/',
      text: 'tesco-site',
      glyph: 'home',
    },
    {
      href: 'https://www-ppe.tesco.pl/help/contact/',
      text: 'contact-us',
      glyph: 'telephone',
    },
    {
      href: 'https://www-ppe.tesco.pl/help/',
      text: 'help',
      glyph: 'information',
    },
    {
  ...
  footerLinks: [
    ...
    },
    {
      ...
      links: [
        {
          text: 'header2.link1',
          href: 'https://www-ppe.tesco.pl/help/terms-and-conditions/',
        },
        {
          text: 'header2.link2',
          href:
            'https://www-ppe.tesco.pl/help/privacy-and-cookies/privacy-centre/privacy-policy-information/privacy-policy/',
        },
        {
          text: 'header2.link3',
          href: 'https://www-ppe.tesco.pl/help/accessibility/',
        },
        {
          text: 'header2.link4',
          href: 'https://www-ppe.tesco.pl/help/privacy-and-cookies/privacy-centre/',
        },
        {
          text: 'header2.link5',
    ...
    },
    {
      ...
      links: [
        {
          text: 'header3.link1',
          href: 'https://www-ppe.tesco.pl/store-locator/uk/',
        },
        {
          text: 'header3.link2',
        ...
        {
          text: 'header3.link3',
          href: 'https://www-ppe.tesco.pl/productrecall/',
        },
        {
          text: 'header3.link4',
          href: 'https://www-ppe.tesco.pl/help/site-map/',
        },
      ],
    },
    {
