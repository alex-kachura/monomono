...
try {
  setGitHubPullRequestStatus state: 'PENDING', context: 'address-book_build_pull_request', message: "Job #${env.BUILD_NUMBER} started"
  ...
  setGitHubPullRequestStatus state: currentBuild.result, context: 'address-book_build_pull_request', message: "Job #${env.BUILD_NUMBER} finished: ${currentBuild.result}"
}
